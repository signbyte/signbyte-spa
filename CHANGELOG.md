...
is written — `XXXXXX-XXXXX`, `XXXXXXXXXXX`, or the qualified `PNOLV-XXXXXX-XXXXX` a card or another system
...
`XXXXXX-XXXXX`, and any other as the full code including its country and type, because a person, a foreign
